...
|---|---|
| **NAS** (Nextcloud, SeaweedFS, Collabora) | The core stack reaches these over **rclone remotes and the S3 API** — a URL, not a container name. |
...
│  Collabora               │   Reached over rclone / S3 URLs.
└──────────────────────────┘
