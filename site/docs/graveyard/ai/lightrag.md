...
- License: MIT
- Alternatives: OpenViking, Chroma, Qdrant, Weaviate
- Status: RIP — replaced by [OpenViking](../../ai/openviking)
...
result as an MCP tool that [hermes-agent](../../ai/hermes) can call when retrieval is warranted.
