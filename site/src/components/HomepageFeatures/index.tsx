...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: <>Notes, photos, money, files — already solved by great open source tools.</>,
  },
  {
    title: 'Solve it once',
    icon: (
    ...
    description: <>Connections, processes, backups, automations — forgotten once set up.</>,
  },
  {
    ...
    description: <>Your files, your GPU. No subscriptions, no cloud required.</>,
  },
];
      ...
      <div className="container">
        <div className={styles.intro}>
          ...
          <p className={styles.lede}>
            Not new software. The good stuff that exists, wired together once.
          </p>
        </div>
        <div className="row">
