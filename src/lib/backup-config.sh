...
hr
echo ""
echo "DB backups (logical dumps) and volume backups run inside one daemon,"
echo "decree-backup, on their own cron schedules."
echo ""
echo "Every cron template ships in one place:"
echo "  services/decree/decree-backup/cron.example/"
echo ""
echo "Activate by copying the templates you want into the active cron/ dir:"
echo "  cp services/decree/decree-backup/cron.example/<name>.md \\"
echo "     services/decree/decree-backup/cron/"
echo "  docker compose restart decree-backup"
echo ""
echo "Defaults:"
