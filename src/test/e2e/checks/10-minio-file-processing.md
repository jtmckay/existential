...
e2e_check: 10-minio-file-processing
...
so cannot be changed by something the daemon is already running: the probe
file-processor, and the webhook's `rclone_prefix`.
