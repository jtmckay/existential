...
every script in automations/lib/file-processors/, tests each PATTERN against
...
Processor convention — each script in automations/lib/file-processors/ declares:
...
Setup:
  ...
  4. Drop a file into MinIO and watch automations/runs/ for the run log.
